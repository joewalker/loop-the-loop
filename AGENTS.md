...
- Markdown paragraphs: one line each. No hard line breaks. Editor handles wrapping
...
- Package upgrade incompatibilities are stored in the `pnpm-workspace.yaml`, `overrides` block.
